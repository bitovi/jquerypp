...
//		jQuery("div").undelegate("#foo", "foo");
	...
	test("bind(), with data, trigger with data", function () {
		...
		jQuery("#firstp").bind("click", {foo : "bar"}, handler).trigger("click", [
			{bar : "foo"}
	...
	test("withinElement implemented with jQuery.contains()", function () {
		...
		jQuery("#jc-outer").bind("mouseenter mouseleave",
			function (event) {
	...
	test("trigger(type, [data], [fn])", function () {
		...
		pass = true;
		try {
			jQuery("#qunit-fixture table:first").bind("test:test",
				function () {
				}).trigger("test:test");
		} catch (e) {
			pass = false;
